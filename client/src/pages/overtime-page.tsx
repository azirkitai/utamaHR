...
export default function OvertimePage() {
  ...
  const employees = [
    {
      ...
      totalWorkHour: "00:00 h",
      totalOvertime: "00:00 h",
      status: "Pending",
      dailyOvertime: {
  ...
  const getDateColumns = () => {
    const dates = [];
    // Sample dates for August 2025 (showing from 31 Jul to some days in Aug)
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-start">
          <div>
            <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
              <span>Home &gt; Attendance &gt; Overtime</span>
            </div>
            <h1 className="text-3xl font-bold text-gray-900">Attendance Overtime</h1>
          </div>
        </div>
        ...
        <Alert className="bg-yellow-50 border-yellow-200">
          <AlertDescription className="text-yellow-800">
            <strong>Note:</strong> Attendance Overtime function will be operational/available from December 2023 onwards, and any data predating this period will not be compatible or supported.
          </AlertDescription>
        </Alert>
                  ...
                  <tr key={employee.id} className="border-b hover:bg-gray-50">
                    ...
                    {dateColumns.map((date, dateIndex) => (
                      <td key={dateIndex} className="p-3 text-center text-gray-600">
                        {(employee.dailyOvertime as any)[date] || "0h"}
                      </td>
                    ))}
                    <td className="p-3 text-center">
